...
#
# FILE:
# Number of Natives of Germanic Nations.R
#
# DESCRIPTION:
...
data <- data.frame(state=c("NEW YORK","ILLINOIS","WISCONSIN","PENNSYLVANIA","OHIO","NORWAY",
...
image_write(img, path = here::here("Original Plot Work", "1890 Number of Natives of Germanic Nations", "Number of Natives of Germanic Nations.png"), format = "png")
