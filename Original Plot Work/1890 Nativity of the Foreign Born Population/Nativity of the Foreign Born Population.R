...
data <- data.frame(country=c("GERMANY","IRELAND","CANADA","ENGLAND","SWEDEN","NORWAY",
...
image_write(img, path = here::here("Original Plot Work", "1890 Nativity of the Foreign Born Population", "Nativity of the Foreign Born Population.png"), format = "png")
