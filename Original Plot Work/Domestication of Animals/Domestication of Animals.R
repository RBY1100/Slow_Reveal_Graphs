...
png(here::here("Original Plot Work", "Domestication of Animals", "temp1.png"),width=500,height=900)
...
original1 <- image_read(here::here("Original Plot Work", "Domestication of Animals", "temp1.png"))
...
box <- image_read(here::here("Original Plot Work", "Domestication of Animals", "Images", "box.png"))
icons <- image_read(here::here("Original Plot Work", "Domestication of Animals", "Images", "icons.png"))
...
image_write(img, path = here::here("Original Plot Work", "Domestication of Animals", "8 Domestication of Animals.png"), format = "png")
