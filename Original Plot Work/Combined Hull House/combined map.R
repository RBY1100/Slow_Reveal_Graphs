...
#topleft
polygon(c(190.8, 207.6, 207.6, 190.8), c(50, 50, 130, 130), border = "#c05a50", col = "#c05a50")
polygon(c(224.4, 207.6, 207.6, 224.4), c(50, 50, 70, 70), border = "#C16E66", col = "#C16E66")
polygon(c(224.4, 207.6, 207.6, 224.4), c(130, 130, 70, 70), border = "#CF8C85", col = "#CF8C85")
polygon(c(224.4, 241.2, 241.2, 224.4), c(130, 130, 50, 50), border = "#CD9E99", col = "#CD9E99")
polygon(c(258, 241.2, 241.2, 258), c(50, 50, 130, 130), border = "#FFA6A6", col = "#FFA6A6")
...
image_write(img, path = here::here("Original Plot Work", "Hull House Wage Map1", "Wage1-Hullhouse.png"), format = "png")
