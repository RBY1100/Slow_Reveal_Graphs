...
#topleft
polygon(c(190.8, 207.6, 207.6, 190.8), c(50, 50, 130, 130), border = "#289426", col = "#289426")
polygon(c(224.4, 207.6, 207.6, 224.4), c(50, 50, 70, 70), border = "#349932", col = "#349932")
polygon(c(224.4, 207.6, 207.6, 224.4), c(130, 130, 70, 70), border = "#4eb55a", col = "#4eb55a")
polygon(c(224.4, 241.2, 241.2, 224.4), c(130, 130, 50, 50), border = "#62bf75", col = "#62bf75")
polygon(c(258, 241.2, 241.2, 258), c(50, 50, 130, 130), border = "#7dd180", col = "#7dd180")
