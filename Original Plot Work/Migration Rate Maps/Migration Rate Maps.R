...
png(here::here("Original Plot Work", "Migration Rate Maps", "Minor Areas", "alaska2.png"),width=120,height=80)
alaska2 <- plot_usmap(
  regions = c("state"),
  include = c("Alaska"),
  color = "black",
...
png(here::here("Original Plot Work", "Migration Rate Maps", "Minor Areas", "alaska3.png"),width=120,height=80)
alaska3 <- plot_usmap(
  regions = c("state"),
  include = c("Alaska"),
  color = "black",
...
png(here::here("Original Plot Work", "Migration Rate Maps", "Minor Areas", "hawaii2.png"),width=65,height=50)
...
png(here::here("Original Plot Work", "Migration Rate Maps", "Minor Areas", "hawaii3.png"),width=65,height=50)
hawaii3 <- plot_usmap(
  regions = c("state"),
  include = c("Hawaii"),
  color = "black",
...
alaska3 <- image_read(here::here("Original Plot Work", "Migration Rate Maps", "Minor Areas", "alaska3.png"))
hawaii1 <- image_read(here::here("Original Plot Work", "Migration Rate Maps", "Minor Areas", "hawaii1.png"))
hawaii2 <- image_read(here::here("Original Plot Work", "Migration Rate Maps", "Minor Areas", "hawaii2.png"))
hawaii3 <- image_read(here::here("Original Plot Work", "Migration Rate Maps", "Minor Areas", "hawaii3.png"))
