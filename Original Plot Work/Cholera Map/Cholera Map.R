...
segments(x0=945, y0=880, x1=910, y1=750, lwd = 1, lty = "solid")
segments(x0=945, y0=880, x1=915, y1=890, lwd = 1, lty = "solid")
segments(x0=915, y0=890, x1=880, y1=760, lwd = 1, lty = "solid")
segments(x0=880, y0=760, x1=910, y1=750, lwd = 1, lty = "solid")
