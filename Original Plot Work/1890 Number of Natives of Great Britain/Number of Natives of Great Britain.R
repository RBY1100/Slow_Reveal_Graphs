...
data <- data.frame(state=c("PENNSYLVANNIA","NEW YORK","MASSACHUSETTS","ILLNOIS","OHIO","MICHIGAN",
...
image_write(img, path = here::here("Original Plot Work", "1890 Number of Natives of Great Britain", "Number of Natives of Great Britain.png"), format = "png")
